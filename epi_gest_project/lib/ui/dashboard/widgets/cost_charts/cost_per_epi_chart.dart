      ...
      PageRouteBuilder(
        ...
        pageBuilder: (context, animation, secondaryAnimation) {
          return AnalysisDrawer(
            title: 'Análise Estratégica de Custos por EPI',
            subtitle: 'Detalhamento de gastos, validades e distribuição.',
            children: [
              // Resumo Geral
              ...
              child: Card.outlined(
                child: ClipRRect(
                  ...
                  child: DataTable(
                    ...
                    columns: [
                      DataColumn(
                        label: Text('EPI', style: _getHeaderStyle(theme)),
                      ),
                      DataColumn(
                        label: Text(
                          'Custo Total',
